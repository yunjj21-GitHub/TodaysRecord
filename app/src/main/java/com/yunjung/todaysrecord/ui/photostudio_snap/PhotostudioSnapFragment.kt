package com.yunjung.todaysrecord.ui.photostudio_snap
...
import com.yunjung.todaysrecord.databinding.FragmentPhotostudioSnapBinding
import com.yunjung.todaysrecord.ui.main.MainActivity
import com.yunjung.todaysrecord.recyclerview.PhotoStudioAdapter

class PhotostudioSnapFragment : Fragment(){
    lateinit var binding : FragmentPhotostudioSnapBinding
    lateinit var viewModel : PhotostudioSnapViewModel

    companion object{
        fun newInstance() : PhotostudioSnapFragment {
            return PhotostudioSnapFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_photostudio_snap, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(PhotostudioSnapViewModel::class.java)
