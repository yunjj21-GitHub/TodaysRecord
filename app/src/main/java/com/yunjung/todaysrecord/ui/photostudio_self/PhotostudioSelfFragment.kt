package com.yunjung.todaysrecord.ui.photostudio_self
...
import com.yunjung.todaysrecord.databinding.FragmentPhotostudioSelfBinding
import com.yunjung.todaysrecord.recyclerview.PhotoStudioAdapter
import com.yunjung.todaysrecord.ui.main.MainActivity

class PhotostudioSelfFragment: Fragment(){
    lateinit var binding : FragmentPhotostudioSelfBinding
    lateinit var viewModel : PhotostudioSelfViewModel

    companion object{
        fun newInstance() : PhotostudioSelfFragment {
            return PhotostudioSelfFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_photostudio_self, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View , savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(PhotostudioSelfViewModel::class.java)
